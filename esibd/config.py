...
ABOUTHTML       = f"""<p>{PROGRAM_NAME} controls all aspects of an ESIBD experiment, including ion beam guiding and steering, beam energy analysis, deposition monitoring, and data analysis.<br>
                    ...
                    Read the docs: <a href='http://esibd-explorer.rtfd.io/'>http://esibd-explorer.rtfd.io/</a> (or click on the book right of the search bar to get to offline documentation) for more details.<br><br>
